...
// }
        ...
        System.out.println("\nTest IMBUFFER, Constructed clock-domain map : ");
        System.out.println(IMBuffer.getInterfaceManagerConfig().getcdmap());
                     ...
                     for (Attribute SOAAttribute : SOAAttributes){
                       ...
                       try {
                            ...
                            //localServAttr.clear();
                                       ...
                                       //     IPChecker = true;
                                      //  }
                            if(SOAAttribute.getName().equalsIgnoreCase("associatedCDName")){
                                SOABuffer.setAdvVisib(SOAAttribute.getValue(),"visible");
                            }
                           } catch (JSONException ex) {
                                        ex.printStackTrace();
                                    }
              ...
              //  }
                ...
                try {
                        ...
                        for(Attribute attribute : attributes){
                                ...
                                if(attribute.getName().equalsIgnoreCase("SOSJDisc") || attribute.getName().equalsIgnoreCase("SOSJDiscReply")){
                                    config.put("CDName",cdname);
                                }
                ...
                //	}
                        ...
                        if(portname.equals("iSignal")){
                                if(!mp.isGenerating()){
                                    ...
                                    if(port.getAttributeValue("Name").equalsIgnoreCase("SOSJDiscReply")){
                                ...
                                if(!mp.isGenerating()){
                                    ...
                                    if (port.getAttributeValue("Name").equalsIgnoreCase("SOSJDisc")){
                                ...
                                if(port.getAttributeValue("From").equalsIgnoreCase(".")){
                                    ...
                                    if(!channels.containsKey(cdname+"."+cname)){
                                        ...
                                        if(SSName.equals(im.getCDLocation(pnames[0]))){
                                               ...
                                               // else 
                                                    //    throw new RuntimeException("1.Tried to initialize the same channel twice : "+ochan.Name);
                                               ...
                                               // else
                                                       // throw new RuntimeException("2. Tried to initialize the same channel twice : "+inchan.Name);
                                ...
                                if(!channels.containsKey(cdname+"."+cname)){
                                        if(SSName.equals(im.getCDLocation(pnames[0]))){
                                               ...
                                               // SJSSCDSignalChannelMap.addInOutChannelObjectToMap(ssname, cdname, "SChannel", "output", port.getAttributeValue("Name"),vec);
                                                ...
                                                //else
                                                //        throw new RuntimeException("3. Tried to initialize the same channel twice : "+inchan.Name);
...
//Vector vec = new Vector();
                                                ...
                                                if(!channels.containsKey(ochan.Name)){
                                                        ...
                                                        throw new RuntimeException("4.Tried to initialize the same channel twice : "+ochan.Name);
                                ...
                                if(!channels.containsKey(cdname+"."+cname)){
                                        ...
                                        if(SSName.equals(im.getCDLocation(pnames[0]))){
                                                ...
                                                if(!channels.containsKey(pname) ){
                                                        ...
                                                        throw new RuntimeException("5.Tried to initialize the same channel twice : "+pname);
                                               ...
                                               // }
                                                ...
                                                if(!channels.containsKey(cdname+"."+cname)){
                                                        ...
                                                        throw new RuntimeException("6. Tried to initialize the same channel twice : "+cdname+"."+cname);
    ...
    RegAllCDStats.AddIntCDMacroState(cdname, "Active");
                ...
                for(Element intf : intfs){
                        ...
                        try {
                                if(!mp.isGenerating()){
                                        ...
                                        RegAllSSAddr.AddSSAddr(SS, ARGS[0]);
