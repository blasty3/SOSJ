...
public abstract class GenericSignalReceiver implements Runnable
{
	...
	public String cdname;
        ...
        protected volatile boolean terminationDone=false;
        protected volatile boolean phyThreadLoop = false;
	/**
	...
	public synchronized void setBuffer(Object[] obj){
        ...
        public synchronized void suspendInputSignalThread(){
         ...
         public synchronized boolean IsInputSignalPhyThreadContLoop(){
             return phyThreadLoop;
         }
         
         
          public synchronized boolean getTerminationDone(){
