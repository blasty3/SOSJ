...
public abstract class GenericSignalSender implements Runnable
{
	...
	public void arun(){ /* blank */}
        /*
          if needed, to reset output physical I/O interface if CD is suspended or killed
        */
        public void resetPhySig(){}
        
         /*
          if needed, to reinstate output physical I/O interface if CD is resumed
        */
