...
public class SystemJRunner
{
	...
	private static void printUsage(){
		...
		System.out.println("Usage: 1st arg - Physical server address. 2nd arg - container 'subsystem' name. 3rd arg - container 'subsystem' physical address");
		//System.out.println();
		//System.out.println("Options:");
		//System.out.println("\t-version\tprint version");
		//System.out.println("\t-x\t\tgenerate bootstrap file");
	...
	public static void main(InputStream input){
        ...
        private static void StartSOSJThreads(){
            ...
            Thread locmsgreceiver = new Thread(new SOSJSOAReceiver());
            Thread msgsender = new Thread(new SOSJSOASender());
           // Thread migMsgRec = new Thread(new MigrationAndLinkReqMsgRecThread());
            Thread migLocMsgRec = new Thread(new MigrationAndLinkReqMsgThread());
        ...
        private static void StartMigAndLinkReqMsgThread(){
            Thread migLocMsgRec = new Thread(new MigrationAndLinkReqMsgThread());
            migLocMsgRec.start();
        }
        
        private static void StartDynReqThread(){
            Thread dynCDMsgRec = new Thread(new DynamicCDReqReceiverThread());
            dynCDMsgRec.start();
        }
        ...
        private static void StartSOARegThread(){
            Thread expirychecker = new Thread(new RegExpiryChecker());
