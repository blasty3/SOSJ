...
public class SJSSCDSignalChannelMap {
    ...
    private static String LocalSSName;
   ...
   // private final static Object InterconnectionObjLock = new Object();
    ...
    private static String LocalSSAddr;
    ...
    */
     ...
     public static void UpdateLocalCurrSignalChannelMap(String LocSSName, JSONObject MapDet){
        
        synchronized(SSSignalChannelMapLock){
            try {
                JSONObject jsLocSSMap = SSSignalChannelMap.getJSONObject(LocSSName);
                
                //jsLocCDsFromMap.put(CDName, MapDet.getJSONObject(CDName));
                
                SSSignalChannelMap.put(LocSSName, jsLocSSMap);
            } catch (JSONException ex) {
                ex.printStackTrace();
            }
        }
