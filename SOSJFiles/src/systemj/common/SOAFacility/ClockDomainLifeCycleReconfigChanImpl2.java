...
public class ClockDomainLifeCycleReconfigChanImpl2 {
                                                            ...
                                                            if(SChansInputConfigs.getString("From").equalsIgnoreCase(".")){
                                                                 ...
                                                                 //channel doesnt have any partner, reconfig goes to check the new partner's rendezvous straightaway
                                                                    ...
                                                                    if(keyCurrSS.equals(im.getCDLocation(newPartnerpnames[0]))){
                                                                                        ...
                                                                                        inchan.TransmitReconfigChanChanges(keyCDName+"."+cname);
                                                            ...
                                                            if(SChansOutputConfigs.getString("To").equalsIgnoreCase(".")){
                                                                 ...
                                                                 //channel doesnt have any partner, reconfig goes to check the new partner's rendezvous straightaway
                                                                    ...
                                                                    if(keyCurrSS.equals(im.getCDLocation(newPartnerpnames[0]))){
                                                                                        ...
                                                                                        ochan.TransmitReconfigChanChanges(keyCDName+"."+cname);
    ...
    public Vector ReconfigDistChannelOnly(String keyCDName, String ChanName, String ChanDir, String NewPartnerChanName, String NewPartnerChanCDName,String PartnerSSName,InterfaceManager im, Scheduler sc){
        //boolean stat = false;
        System.out.println("ReconfigDistChannelOnly invoked");
        Vector vec = new Vector();
        if(!NewPartnerChanCDName.equals("")){
            im.addCDLocation(PartnerSSName, NewPartnerChanCDName);
        }
        Hashtable channels = im.getAllChannelInstances();
        JSONObject jsAll = SJSSCDSignalChannelMap.getCurrentSignalChannelMapping();
        String SSName = SJSSCDSignalChannelMap.getLocalSSName();
        try {
            JSONObject jsLocalCDs = jsAll.getJSONObject(SSName);
            JSONObject jsCD = jsLocalCDs.getJSONObject(keyCDName);
            ClockDomain cdins = null;
            if(sc.SchedulerHasCD(keyCDName)){
                cdins = sc.getClockDomain(keyCDName);
            } else if (CDObjectsBuffer.CDObjBufferHas(keyCDName)){
            ...
            JSONObject jsSChansInd = jsCD.getJSONObject("SChannels");
            if(ChanDir.equals("input")){
                ...
                if(NewPartnerChanCDName.equals("") || NewPartnerChanName.equals("")){
                    pname = ".";
                    ...
                    pname = NewPartnerChanCDName+"."+NewPartnerChanName+"_o";
                    inchan.PartnerName = pname;
                    inchan.setInit();
                    inchan.setDistributed();
                    inchan.setInterfaceManager(im);
                    inchan.TransmitInChanStat();
                }
                ...
                //String pname = NewPartnerChanCDName+"."+NewPartnerChanName+"_o";
                                                                        ...
                                                                        SChansInputConfigs.put("From", NewPartnerChanCDName+"."+NewPartnerChanName);
                                                                        jsSChansInputs.put(ChanName, SChansInputConfigs);
                                                                        jsSChansInd.put("inputs",jsSChansInputs);
                                                                        jsCD.put("SChannels", jsSChansInd);
                                                                        jsLocalCDs.put(keyCDName,jsCD);
                                                                        jsAll.put(SSName, jsLocalCDs);
                                                                        SJSSCDSignalChannelMap.UpdateAllCurrSignalChannelMapping(jsAll);
                                                                        
                                                                        
                                                                        
                                                                        
                
            } else if (ChanDir.equals("output")){
                JSONObject jsSChansOutputs = jsSChansInd.getJSONObject("outputs");
                JSONObject SChanOutputConfigs = jsSChansOutputs.getJSONObject(ChanName);
                String cname = ChanName.trim()+"_o";
                ...
                if(NewPartnerChanCDName.equals("") || NewPartnerChanName.equals("")){
                    ...
                    pname = NewPartnerChanCDName+"."+NewPartnerChanName+"_in";
                    ochan.PartnerName = pname;
                    ochan.setDistributed();
                    ochan.setInit();
                    ochan.setInterfaceManager(im);
                    ochan.TransmitOutChanStat();
                }
                
                                                                                    channels.put(ochan.Name, ochan);
                                                                                    
                                                                                    SChanOutputConfigs.put("To", NewPartnerChanCDName+"."+NewPartnerChanName);
                                                                                jsSChansOutputs.put(ChanName, SChanOutputConfigs);
                                                                                jsSChansInd.put("outputs",jsSChansOutputs);
                                                                                jsCD.put("SChannels", jsSChansInd);
                                                                                jsLocalCDs.put(keyCDName,jsCD);
                                                                                jsAll.put(SSName, jsLocalCDs);
                                                                                SJSSCDSignalChannelMap.UpdateAllCurrSignalChannelMapping(jsAll);
            ...
            if(sc.SchedulerHasCD(keyCDName)){
                sc.updateClockDomain(cdins, keyCDName);
            } else if (CDObjectsBuffer.CDObjBufferHas(keyCDName)){
