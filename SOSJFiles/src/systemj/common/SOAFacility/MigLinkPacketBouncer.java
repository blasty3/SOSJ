 ...
 * @author Udayanto
 */
public class MigLinkPacketBouncer implements Runnable{

    //private MulticastSocket socket;
    private String message;
    
    
    MigLinkPacketBouncer(String message){
        //.socket=socket;
        ...
        try{
            ...
            byte[] msg = new byte[65507];
                                                                                              ...
                                                                                              //out.writeObject(SJServiceRegistry.obtainInternalRegistry().toString());
                                                                                                ...
                                                                                                DatagramPacket hi = new DatagramPacket(msg, msg.length, ipAddress, 1078);
