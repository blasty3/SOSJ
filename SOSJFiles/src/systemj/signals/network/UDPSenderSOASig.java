...
public class UDPSenderSOASig extends GenericSignalSender implements Serializable
{
	...
	public void run()
	{
		...
		try
		{
			byte[] tosend = new byte[1];
                        JSONObject jsMsg = new JSONObject(new JSONTokener(super.buffer[1].toString()));
                                        address = InetAddress.getByName(jsMsg.getString("destAddr"));
                                        port = Integer.parseInt(jsMsg.getString("destPort"));
