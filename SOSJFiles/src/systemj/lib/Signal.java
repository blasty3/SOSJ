...
public class Signal implements Serializable{
	...
	public void setuphook(){
        ...
        public boolean getInputSignalThreadTerminated(){
            return server.getTerminationDone();
        }
        ...
        public void wakeupInputSignalThread(){
         ...
         public boolean IsInputSignalPhyThreadContLoop(){
             return server.IsInputSignalPhyThreadContLoop();
         }
